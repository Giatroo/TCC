...
\begin{enumerate}
  \item $\pair{1}{1}$, caso \textit{verdadeiro positivo} (do inglês,
    \textit{true positive} e denotado por $tp$).
  \item $\pair{0}{1}$, caso \textit{falso positivo} (do inglês, \textit{false
    positive} e denotado por $fp$).
  \item $\pair{0}{0}$, caso \textit{verdadeiro negativo} (do inglês,
    \textit{true negative} e denotado por $tn$).
  \item $\pair{1}{0}$, caso \textit{falso negativo} (do inglês, \textit{false
    negative} e denotado por $fn$).
\end{enumerate}
